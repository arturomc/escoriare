...
describe("scraper", () => {
    ...
    const products = [
      {
        title: "Mock Product",
        price: "99.99",
        link: "https://www.amazon.com.mx/Mock-Product/dp/B07YXJ9XZ8",
      },
    ];
  ...
  test("POST /scrape returns a 200 status code", async () => {
    ...
    testScrapUrl =
      "https://www.amazon.com.mx/s?k=all+headphones&crid=2TTXQBOK238J3&qid=1667301526&sprefix=all+headphones%2Caps%2C284&ref=sr_pg_1";
